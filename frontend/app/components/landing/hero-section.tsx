    ...
    return (
        <section className="relative flex min-h-screen items-center justify-center overflow-hidden px-6">
            ...
            >
                ...
                >
                    Got free time? Earn with FreeHour.
                </motion.p>
                ...
                >
                    AI-governed micro-task economy for verified college students and professionals.
                    Post tasks, get paid, and build your reputation.
                </motion.p>
                ...
                >
                    {["Escrow Protected", "AI Pricing", "Verified Students"].map((text, i) => (
                        <motion.span
                            key={text}
                            initial={{ opacity: 0 }}
                            animate={{ opacity: 1 }}
