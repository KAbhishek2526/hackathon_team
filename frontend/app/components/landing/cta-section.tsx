            ...
            <div className="mx-auto max-w-4xl text-center">
                ...
                >
                    <h2 className="text-balance font-mono text-3xl font-bold text-foreground sm:text-5xl">
                        Ready to earn with your free hours?
                    </h2>
                    <p className="mx-auto mt-6 max-w-lg text-pretty text-muted-foreground">
                        Join thousands of verified college students already earning through FreeHour.
                        Post tasks, get paid, build your reputation.
                    </p>
