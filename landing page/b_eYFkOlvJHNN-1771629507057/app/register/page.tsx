  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center bg-background px-6">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, hsla(330, 80%, 55%, 0.2) 0%, transparent 70%)",
        }}
        aria-hidden="true"
      />
      ...
      >
        ...
        <div className="overflow-hidden rounded-2xl border border-border/50 bg-card/30 p-8 backdrop-blur-xl">
          ...
          <h1 className="font-mono text-2xl font-bold text-foreground">Create your account</h1>
          <p className="mt-2 text-sm text-muted-foreground">
            Start making the most of your free time
          </p>
